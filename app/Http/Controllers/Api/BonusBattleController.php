...
class BonusBattleController
{
    ...
    public function create(Request $request)
    {
        ...
        $currency = Currency::find(auth('sanctum')->user()->clientCurrency()->id());
        ...
        */
        if (auth('sanctum')->user()->clientCurrency()->id() === 'local_bonus' || auth('sanctum')->user()->clientCurrency()->id() === 'bonus' || auth('sanctum')->user()->clientCurrency()->id() === 'BONUS') {
        ...
        auth('sanctum')->user()->balance(Currency::find(auth('sanctum')->user()->clientCurrency()->id()))->subtract($amount, Transaction::builder()->message('Bonus battle creation')->get());
