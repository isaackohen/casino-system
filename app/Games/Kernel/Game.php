...
abstract class Game
{
    ...
    abstract public function process(Data $data);

    abstract public function result(ProvablyFairResult $result): array;
    ...
    public function isDisabled(): bool
    {
        ...
        if (Cache::has('disabledGame:'.$this->metadata()->id())) {
            return Cache::get('disabledGame:'.$this->metadata()->id());
        }
