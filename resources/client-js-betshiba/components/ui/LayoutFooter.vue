            ...
            <div class="footer">
                <div class="column">
                    <div class="logo">
                        <div class="logo"></div>
                        <div class="socials">
                            <div class="social" @click="openExternalUrl($t('site_identity.telegram'))"><icon icon="fab fa-telegram"></icon></div>
                    ...
                    <div class="info">
                        ...
                        <a @click="openExternalUrl($t('site_identity.telegram'))">Live-Chat</a>
                    </div>
                </div>
                <div class="column">
                    <div class="copy">
                    ...
                    <div class="footer-logo" @click="openExternalUrl($t('site_identity.telegram'))">{{ $t('site_identity.website_footer') }} Casino</div>
                </div>
            </div>
        </div>
    </footer>
