<template>
    <div class="container-fluid">
        <div class="walletPage inner-content-max">
                        ...
                        <div class="walletColumnContent">
                            ...
                            <template v-else>
                                ...
                                <div class="walletButtons">
                                    <div :class="`walletButton ${sum === 50 ? 'active' : ''}`" @click="sum = 50">
                                        50
                                    </div>
                                    <div :class="`walletButton ${sum === 100 ? 'active' : ''}`" @click="sum = 100">
                                        100
                                    </div>
                                    <div :class="`walletButton ${sum === 250 ? 'active' : ''}`" @click="sum = 250">
                                        250
                                    </div>
