    ...
    export default {
        ...
        methods: {
            ...
            toggleDemoMode(mode, state) {
	            ...
	            axios.post('/api/externalGame/getUrl', { id: this.$route.params.id, roomid: this.$route.params.roomid, mode: mode}).then(({ data }) => {
        ...
        created() {
			this.RealMode = true;
            axios.post('/api/externalGame/getUrl', { id: this.$route.params.id, roomid: this.$route.params.roomid, mode: this.RealMode }).then(({ data }) => {
                this.externalgame = data;
